...
#define MANUAL_Z_HOME_POS 186.8 // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {111, 111, 111, 673.65}  // defaults from RichRap, esteps are mine
